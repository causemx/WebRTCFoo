...
//
//  private String keyprefVideosettings;
...
//    keyprefVideosettings= "video_settings_key";
...
//    disablePreference();
  ...
  protected void onResume() {
    super.onResume();
    // Set summary to be the user-description for the selected value0n
...
//    updateSummaryC(sharedPreferences, keyprefVideosettings);
...
//        || key.equals(keyprefDataId)
      ...
      updateSummary(sharedPreferences, key);
            ...
            key.equals(keyprefMaxVideoBitrateValue)
        || key.equals(keyprefStartAudioBitrateValue)
    ) {
      updateSummaryBitrate(sharedPreferences, key);
    }*/ else if (
//            key.equals(keyprefVideoCall)
...
//    if(key == "keyprefCamera2"){
//      disablePreference();
//    }
  }

//  private void updateSummaryC(SharedPreferences sharedPreferences, String key){
//    PreferenceCategory updatePref = (PreferenceCategory) settingsFragment.findPreference(key);
//    updatePref.removeAll();
//  }
...
//
//    PreferenceCategory videosettingkey = (PreferenceCategory) settingsFragment.findPreference("pref_videosettings_key");
//    Preference camera2key = settingsFragment.findPreference(keyprefCamera2);
//    System.out.println("ynhuang, videosettingkey: " + videosettingkey);
//    System.out.println("ynhuang, camera2key: " + camera2key);
//    camera2key.setEnabled(false);
////    videosettingkey.removePreference(settingsFragment.findPreference("pref_camera2_key"));
//  }
}
