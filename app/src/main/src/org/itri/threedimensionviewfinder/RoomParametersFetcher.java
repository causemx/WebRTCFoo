...
import org.itri.threedimensionviewfinder.util.AsyncHttpURLConnection;
import org.itri.threedimensionviewfinder.util.AsyncHttpURLConnection.AsyncHttpEvents;
...
public class RoomParametersFetcher {
  ...
  private void roomHttpResponseParse(String response) {
    ...
    try {
      ...
      Log.d(TAG, "ynhuang signalingPara(iceServers): " + iceServers);
      Log.d(TAG, "ynhuang signalingPara(initiator): " + initiator);
      Log.d(TAG, "ynhuang signalingPara(clientId): " + clientId);
      Log.d(TAG, "ynhuang signalingPara(wssUrl): " + wssUrl);
      Log.d(TAG, "ynhuang signalingPara(wssPostUrl): " + wssPostUrl);
      Log.d(TAG, "ynhuang signalingPara(offerSdp): " + offerSdp);
      Log.d(TAG, "ynhuang signalingPara(iceCandidates): " + iceCandidates);
...
//    connection.setDoOutput(true);
    connection.setRequestProperty("REFERER", "http://35.221.136.2:8080");  //"https://appr.tc");
